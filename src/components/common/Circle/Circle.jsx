...
const Circle = ({ h2Text, h3Text = "", position = "relative", className = "", size = "large", animationDelay = "0s", animated = true }) => {
  ...
  return (
    <div
      className={`${styles.circle} ${sizeClass} ${positionClass} ${animatedClass} items-center justify-center flex flex-col text-center ${className}`}
